...
public class Task4_CustomerFifo {
    private int id;
    private long startTime;
    private long endTime;
    private static int idCount = 1;

    public Task4_CustomerFifo() {
        setId(idCount);
        idCount++;
    }
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            LinkedList<Task4_CustomerFifo> queue = new LinkedList<>();
            ...
            while (ongoing) {
                ...
                switch (command) {
                    ...
                    case 1 -> {
                        Task4_CustomerFifo customer = new Task4_CustomerFifo();
                    ...
                    case 2 -> {
                        if (!queue.isEmpty()) {
                            Task4_CustomerFifo customer = queue.removeLast();
