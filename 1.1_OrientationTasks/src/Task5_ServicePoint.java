...
class CustomerGenerator {
    public static void createCustomer(int amountOfCustomers, Task5_ServicePoint servicePoint) {
...
public class Task5_ServicePoint {
    ...
    public static void main(String[] args) {
        ...
        Task5_ServicePoint servicePoint = new Task5_ServicePoint();
